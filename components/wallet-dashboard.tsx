...
export function WalletDashboard() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f5f0fa]">
      {/* Header */}
      <header className="flex items-center justify-between p-2 sm:p-4 bg-white border-b">
        <div className="flex items-center gap-2">
          <Button variant="ghost" size="icon" className="text-gray-500">
            <ArrowLeft className="h-4 w-4 sm:h-5 sm:w-5" />
          </Button>
          <h1 className="text-base sm:text-lg font-semibold">Wallet Management</h1>
        </div>
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div className="relative">
            <Button variant="ghost" size="icon" className="text-gray-500 relative h-8 w-8 sm:h-10 sm:w-10">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M18 8C18 6.4087 17.3679 4.88258 16.2426 3.75736C15.1174 2.63214 13.5913 2 12 2C10.4087 2 8.88258 2.63214 7.75736 3.75736C6.63214 4.88258 6 6.4087 6 8C6 15 3 17 3 17H21C21 17 18 15 18 8Z"
                  stroke="currentColor"
              ...
              <span className="absolute -top-0.5 -right-0.5 flex h-3 w-3 sm:h-4 sm:w-4 items-center justify-center rounded-full bg-red-500 text-[8px] sm:text-[10px] font-bold text-white">
                1
              </span>
            </Button>
          </div>
          <div className="h-7 w-7 sm:h-8 sm:w-8 rounded-full bg-purple-100 overflow-hidden">
            <img src="/photo-frame.png?height=32&width=32" alt="Profile" className="h-full w-full object-cover" />
          </div>
        </div>
      </header>
      ...
      <main className="flex-1 p-4 md:p-8 max-w-5xl mx-auto w-full">
        <div className="bg-white rounded-lg p-4 md:p-6 shadow-sm">
          {/* Balance Card */}
          <Card className="bg-[#4b0082] text-white mb-4 sm:mb-6 border-0">
            <CardContent className="p-3 sm:p-4 md:p-6">
              <div className="flex justify-between items-center mb-3 sm:mb-4">
                <div>
                  <p className="text-xs sm:text-sm opacity-80">Total Balance</p>
                  <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mt-1">$24,562.00</h2>
                </div>
                <div className="flex items-center gap-1 bg-[#5c1a99] rounded-md px-2 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm">
                  <span>{currency}</span>
                  <ChevronDown className="h-3 w-3 sm:h-4 sm:w-4" />
                </div>
              </div>
              <div className="flex flex-wrap gap-1 sm:gap-2 mt-3 sm:mt-4">
                <Button className="bg-[#5c1a99] hover:bg-[#6b2ba8] text-white rounded-md flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-1 sm:py-2 h-7 sm:h-9 text-[10px] xs:text-xs md:text-sm">
                  <span>Add Money</span>
                </Button>
                <Button className="bg-[#5c1a99] hover:bg-[#6b2ba8] text-white rounded-md flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-1 sm:py-2 h-7 sm:h-9 text-[10px] xs:text-xs md:text-sm">
          ...
          {/* Recent Transactions */}
          <div className="bg-[#f8f4fc] rounded-lg p-3 sm:p-4 mb-4 sm:mb-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3 sm:mb-4 gap-2">
              <h3 className="font-semibold text-sm sm:text-base">Recent Transactions</h3>
              <div className="flex gap-2">
                <Button
                  variant="ghost"
                  className="flex items-center gap-1 text-[10px] xs:text-xs md:text-sm h-7 sm:h-8 px-1.5 sm:px-2 md:px-3 rounded-md bg-white"
                >
                  <span>{typeFilter}</span>
                  <ChevronDown className="h-3 w-3 sm:h-4 sm:w-4" />
                </Button>
          ...
          <div className="grid grid-cols-1 gap-4 sm:gap-6">
            {/* Linked Cards */}
            <div className="bg-[#f8f4fc] rounded-lg p-3 sm:p-4">
              <h3 className="font-semibold text-sm sm:text-base mb-3 sm:mb-4">Linked Cards</h3>
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="h-7 w-7 sm:h-8 sm:w-8 rounded-md bg-purple-900 flex items-center justify-center">
                      <CreditCard className="h-3 w-3 sm:h-4 sm:w-4 text-white" />
                    </div>
                    <div>
                      <p className="font-medium text-xs sm:text-sm">Visa ending in 4242</p>
                      <p className="text-[10px] sm:text-xs text-gray-500">Expires 08/25</p>
                    </div>
                  </div>
              ...
              <Button
                variant="ghost"
                className="w-full mt-3 sm:mt-4 border border-dashed border-gray-300 text-purple-700 hover:bg-purple-50 hover:text-purple-800 text-xs sm:text-sm py-1 sm:py-2 h-auto"
              >
                <span className="mr-1 sm:mr-2">+</span> Add New Card
              </Button>
            </div>

            {/* Crypto Wallets */}
            <div className="bg-[#f8f4fc] rounded-lg p-3 sm:p-4">
              <h3 className="font-semibold text-sm sm:text-base mb-3 sm:mb-4">Crypto Wallets</h3>
              <div className="space-y-2 sm:space-y-3">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="h-7 w-7 sm:h-8 sm:w-8 rounded-md bg-orange-500 flex items-center justify-center">
                      <svg
                        width="14"
                        height="14"
                        viewBox="0 0 24 24"
                    ...
                    <div>
                      <p className="font-medium text-xs sm:text-sm">Bitcoin Wallet</p>
                      <p className="text-[10px] sm:text-xs text-gray-500">0.0234 BTC</p>
                    </div>
                  </div>
                  <Button variant="ghost" size="icon" className="h-7 w-7 sm:h-8 sm:w-8">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Button
                ...
                className="w-full mt-3 sm:mt-4 border border-dashed border-gray-300 text-purple-700 hover:bg-purple-50 hover:text-purple-800 text-xs sm:text-sm py-1 sm:py-2 h-auto"
              >
                <span className="mr-1 sm:mr-2">+</span> Add New Wallet
              </Button>
            </div>
          </div>

          {/* Security Settings */}
          <div className="bg-[#f8f4fc] rounded-lg p-3 sm:p-4 mt-4 sm:mt-6">
            <h3 className="font-semibold text-sm sm:text-base mb-3 sm:mb-4">Security Settings</h3>
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2 sm:gap-3">
                  <div className="h-7 w-7 sm:h-8 sm:w-8 rounded-md bg-purple-100 flex items-center justify-center">
                    <Lock className="h-3 w-3 sm:h-4 sm:w-4 text-purple-700" />
                  </div>
                  <div>
                    <p className="font-medium text-xs sm:text-sm">Two-Factor Authentication</p>
                    <p className="text-[10px] sm:text-xs text-gray-500">Secure your account with 2FA</p>
                  </div>
                </div>
                <Switch />
              </div>
