...
export function AddMoney() {
  ...
  const paymentMethods = [
    {
      ...
      name: "Bank Transfer",
      icon: (
        <div className="h-5 w-5 sm:h-6 sm:w-6 rounded-md bg-blue-100 flex items-center justify-center">
          <svg
            width="12"
            height="12"
    ...
    },
    {
      ...
      name: "UPI",
      icon: (
        <div className="h-5 w-5 sm:h-6 sm:w-6 rounded-md bg-green-100 flex items-center justify-center">
          <svg
            width="12"
            height="12"
    ...
    },
    {
      ...
      name: "Credit/Debit Card",
      icon: (
        <div className="h-5 w-5 sm:h-6 sm:w-6 rounded-md bg-purple-100 flex items-center justify-center">
          <svg
            width="12"
            height="12"
    ...
    },
    {
      ...
      name: "Crypto Wallet",
      icon: (
        <div className="h-5 w-5 sm:h-6 sm:w-6 rounded-md bg-orange-100 flex items-center justify-center">
          <svg
            width="12"
            height="12"
            className="sm:w-4 sm:h-4 text-orange-600"
            viewBox="0 0 24 24"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#f5f0fa]">
      ...
      {/* Main Content */}
      <main className="flex-1 p-3 sm:p-4 md:p-8 max-w-5xl mx-auto w-full">
        <div className="bg-white rounded-lg p-3 sm:p-4 md:p-6 shadow-sm">
          {/* Back Button */}
          <div className="mb-4 sm:mb-6">
            <Button
              variant="ghost"
              className="text-purple-700 p-0 h-auto flex items-center gap-1 hover:bg-transparent text-sm"
            >
          ...
          <Card className="bg-[#4b0082] text-white mb-4 sm:mb-6 border-0">
            <CardContent className="p-3 sm:p-4 md:p-6">
              <div>
                ...
                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mt-1">$2,458.65</h2>
              </div>
            </CardContent>
          </Card>
          ...
          {/* Quick Select Amount */}
          <div className="mb-4 sm:mb-6">
            <p className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3">Quick Select Amount</p>
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
              {quickAmounts.map((item) => (
                <button
                  key={item.value}
                  className={cn(
                    "py-2 sm:py-3 rounded-md text-center transition-colors text-xs sm:text-sm",
                    selectedAmount === item.value
                      ? "bg-purple-200 text-purple-700"
                      : "bg-[#f8f4fc] text-gray-700 hover:bg-purple-100",
                  )}
          ...
          {/* Custom Amount */}
          <div className="mb-4 sm:mb-6">
            <p className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3">Custom Amount</p>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">$</span>
              <Input
                type="number"
                value={amount}
                onChange={handleAmountChange}
                className="pl-8 bg-[#f8f4fc] border-0 focus-visible:ring-purple-500 h-9 sm:h-10 text-sm"
                placeholder="Enter amount"
              />
            </div>
          </div>
          ...
          {/* Select Payment Method */}
          <div className="mb-4 sm:mb-6">
            <p className="text-xs sm:text-sm text-gray-600 mb-2 sm:mb-3">Select Payment Method</p>
            <div className="space-y-2 sm:space-y-3">
              {paymentMethods.map((method) => (
                <button
                  key={method.id}
                  className={cn(
                    "w-full flex items-center justify-between p-2 sm:p-3 rounded-md transition-colors text-xs sm:text-sm",
                    selectedMethod === method.id
                      ? "bg-purple-100 border border-purple-200"
                      : "bg-[#f8f4fc] hover:bg-purple-50",
                  )}
          ...
          {/* Add Money Button */}
          <Button
            className="w-full bg-[#4b0082] hover:bg-[#5c1a99] text-white py-4 sm:py-6 text-sm sm:text-base"
            disabled={!amount || !selectedMethod}
          >
            Add Money
          </Button>
